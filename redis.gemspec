...
Gem::Specification.new do |s|
  ...
  s.files = ["LICENSE", "README.markdown", "Rakefile", "lib/edis.rb", "lib/redis", "lib/redis/client.rb", "lib/redis/compat.rb", "lib/redis/distributed.rb", "lib/redis/hash_ring.rb", "lib/redis/pipeline.rb", "lib/redis/raketasks.rb", "lib/redis/subscribe.rb", "lib/redis.rb", "tasks/redis.tasks.rb"]
